...
# Main Library
csv_parser:
	$(CXX) -o csv_parser.o -I$(IDIR) -shared -fPIC -O3 --coverage $(CFLAGS) $(IDIR)csv_parser.h $(IDIR)csv_parser.cpp $(IDIR)csv_stat.cpp $(IDIR)csv_merge.cpp $(IDIR)data_type.cpp
