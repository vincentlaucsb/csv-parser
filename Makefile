...
# Main Library
csv_parser:
	$(CXX) -o -I$(IDIR) -shared -fPIC -O3 --coverage $(CFLAGS) csv_parser.o $(IDIR)csv_parser.h $(IDIR)csv_parser.cpp $(IDIR)csv_stat.cpp $(IDIR)csv_merge.cpp $(IDIR)data_type.cpp
